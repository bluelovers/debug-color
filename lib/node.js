...
class Console2 {
    constructor(target = console, options) {
        ...
        // @ts-ignore
        this[val_2.SYM_DATA] = Object.create({
            colors: Object.create(exports.defaultColors),
        });
        // @ts-ignore
        this[val_2.SYM_DATA].stream = !!(console._stdout && console._stderr);
        Object.assign(this[val_2.SYM_DATA], options || {});
    }
    get chalk() {
    ...
    get inspectOptions() {
        return this[val_2.SYM_DATA].inspectOptions;
    }
    set inspectOptions(value) {
        this[val_2.SYM_DATA].inspectOptions = value;
    }
    get enabled() {
        return this[val_2.SYM_DATA].enabled !== false;
    }
    set enabled(value) {
        this[val_2.SYM_DATA].enabled = value === true;
    }
    setOptions(options) {
        Object.assign(this[val_2.SYM_DATA], options);
        return this;
    ...
    withOptions(options) {
        ...
        o[val_2.SYM_DATA] = Object.assign({}, this[val_2.SYM_DATA], options);
        return o;
    }
    _clone() {
        const self = this;
        ...
        o[val_2.SYM_DATA] = self[val_2.SYM_DATA];
        // @ts-ignore
        return o;
    }
...
FillProperty.methods.forEach(function (name) {
    if (name == 'dir') {
        Console2.prototype[name] = function chalkStyleLogOthers(object, options) {
            ...
            if (!options && this[val_2.SYM_DATA].inspectOptions) {
                options = this[val_2.SYM_DATA].inspectOptions;
            }
            if (options) {
