...
export declare const methods: ("debug" | "error" | "info" | "log" | "trace" | "warn" | "exception" | "markTimeline" | "timeline" | "timelineEnd" | "assert" | "clear" | "count" | "dir" | "dirxml" | "group" | "groupCollapsed" | "groupEnd" | "table" | "time" | "timeEnd" | "timeStamp" | "profile" | "profileEnd")[];
